---
title: Why civic tech projects fail (and succeed)
description: After a decade mapping thousands of democracy-tech projects, Matt Stempeck has seen the same failure patterns over and over — and a handful of things that actually work.
---

People build technology to improve democracy all the time. Most of it doesn't last. Matt Stempeck has spent a decade running the [Civic Tech Field Guide](/ecosystem/overview/) — a crowdsourced directory of more than 11,000 democracy-tech projects — which means he's also catalogued how and why they fail. The patterns repeat.

## Three ways civic tech projects fail
...
This connects to how platforms touch democracy at all — see [civic products, externalities & features](/concepts/civic-products-and-features/) — and to the work of letting the tools that *do* survive talk to each other, in [connecting the tools](/concepts/interoperability-and-standards/).
