...
description: Four different things people mean by "democratising AI" — using it, building it, sharing its profits, and governing it — and why mixing them up lets companies claim credit for the easy ones.
---
...
- **Democratising *governance*** — distributing influence over *if, how, and by whom* AI is built, used, and shared. [Collective constitutional AI](/concepts/constitutional-agents/), and the [alignment assemblies](/run-reports/taiwan-alignment-assemblies/) run by the Collective Intelligence Project.
...
## Preferences are not control

Asking the public what it wants is not the same as handing it the controls. The philosopher Théophile Pénigaud credits OpenAI, Meta and Anthropic for programmes that gather public input into how their models behave, then draws the line: there is a crucial difference between eliciting people's existing preferences to inform a design, and subjecting that design — its purposes and its wider ethical, political and economic consequences — to **open democratic revision and contestation**. Only the second, he argues, preserves collective self-determination. It matters because chatbots now shape how millions of people reason about decisions that affect others (see [orphan reasons](/concepts/orphan-reasons/)), which in his words makes alignment "a quasi-constitutional problem" rather than a purely technical one.

## The sharper provocation
...
A different route to the harder two meanings — *development* and *profits* — starts from labour rather than law. Trebor Scholz and Mark Esposito describe today's AI as a vertically integrated **"extraction stack"** (hardware, cloud, models, labour, applications) controlled by a few firms, and its hidden workforce — content moderators in Nairobi, Manila and Hyderabad paid little to absorb a daily stream of traumatic material — as the people it "isolates and breaks." Their alternative is a **"solidarity stack"**: reclaiming each layer through cooperative ownership instead of renting space on the extractive one. They point to pieces already working — MIDATA, a Swiss health-data cooperative governed by the patients whose records it holds; the Gamayyar African Tech Workers Cooperative in Kenya, started by a former Meta moderator; rural electric cooperatives as the historical proof that communities can own infrastructure — and put the count at 1.2 million workers across 53 countries. Like the [social-technology reframe](/concepts/civic-ai/), they reject "the notion of artificial intelligence, which implies a magical, autonomous force," renaming it collective intelligence to keep the human labour in view. It's the [commons](/concepts/the-commons/) logic applied to the AI stack, and it meets [public AI](/concepts/public-ai/) on shared infrastructure like Apertus.

For the deeper critique of whether any of this is enough, see [does AI weaken democratic institutions?](/concepts/does-ai-weaken-institutions/); for the infrastructure angle, [public AI](/concepts/public-ai/); for the market-inspired mechanisms behind profit-sharing, [plural mechanisms](/concepts/plural-mechanisms/).

## Sources

- Elizabeth Seger, Aviv Ovadya, Ben Garfinkel, Divya Siddarth & Allan Dafoe, "Democratising AI: Multiple Meanings, Goals, and Methods," 2023: [arxiv.org/abs/2303.12642](https://arxiv.org/abs/2303.12642) · [governance.ai](https://www.governance.ai/research-paper/democratising-ai-multiple-meanings-goals-and-methods)
- Collective Intelligence Project "Democratic AI" panel (Divya Siddarth, Saffron Huang, Manu Chopra, Teddy Lee, Amba Kak, Yoshua Bengio), 2024: [youtube.com/watch?v=OQxMGMB5kL8](https://www.youtube.com/watch?v=OQxMGMB5kL8)
- "The Indian Startup Making AI Fairer — While Helping the Poor" — TIME on Karya, 2023: [time.com](https://time.com/6297403/the-workers-behind-ai-rarely-see-its-rewards-this-indian-startup-wants-to-fix-that/)
- Justin Rosenstein (One Project), "How to Make AI Serve the Public," 2026 — the four democratic claims and the Global AI Assembly (GAIA): [oneproject.org](https://oneproject.org/how-to-make-ai-serve-the-public/)
- R. Trebor Scholz & Mark Esposito, "Building a Solidarity Ecosystem for AI" — Stanford Social Innovation Review, 2026: [ssir.org](https://ssir.org/articles/entry/artificial-intelligence-solidarity-ecosystem)
- Théophile Pénigaud, "Orphan Reasons: Who Is Responsible When AI Decides?" — Informational Democracy, 2026: [informationaldemocracy.substack.com](https://informationaldemocracy.substack.com/p/orphan-reasons-who-is-responsible)
