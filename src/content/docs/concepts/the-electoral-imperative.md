...
The electoral imperative is the load-bearing premise beneath the whole sortition argument. If the problem were merely *which* people we elect, better candidates or cleaner elections would fix it. Because the problem is the *incentive the role creates*, the proposed remedy is to change the incentive — to make decisions through bodies that have no next election to win. That is the thread connecting [sortition](/concepts/sortition/), the [multi-body design](/concepts/multi-body-sortition/), and the [objections and answers](/concepts/objections-to-sortition/): remove the imperative, and most of these pathologies lose their engine. It is the same reason [institutionalising deliberation](/concepts/institutionalising-deliberation/) matters — a one-off assembly leaves the imperative in charge of everything else.
