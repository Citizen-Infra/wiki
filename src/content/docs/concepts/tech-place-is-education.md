---
title: Technology's place is education
description: Why the bottleneck on better self-governance is human literacy, not tooling — and a simple test for when technology actually helps.
---

A recurring theme among people who've spent years helping groups govern themselves: the limiting factor is rarely a missing tool. It's a missing *literacy* — the human capacity to share power, facilitate, and decide together. Get that backwards, and you build "boxes" that don't let people do what they actually need to do.

## Education first, then tools

If you treat self-governance as fundamentally an **educational** project rather than a mechanical one, technology's role changes. It stops being the thing that produces good democracy and becomes a way to make education *motivated, well-structured, and consistent across people* — a tool people use to come together and practise, not a replacement for the practice.

Seen this way, even AI looks different: not an engine that generates good decisions, but something that can help more people build the skills and connections that good decisions require.
