...
- [Sortition](/concepts/sortition/) — the idea itself, and the case *for* choosing by lot
- [Multi-body sortition](/concepts/multi-body-sortition/) — the design the accountability and competence answers depend on
- [The epistemic case for democracy](/concepts/epistemic-democracy/) — why diverse groups can out-reason experts
- [What a citizens' assembly is](/concepts/citizens-assembly/) and [deliberative polling](/concepts/deliberative-polling/) — the evidence base behind the competence answer
