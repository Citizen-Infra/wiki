...
- [ ] https://publications.jrc.ec.europa.eu/repository/handle/JRC145311 — EU Joint Research Centre (foresight report): Futures of EU democracy — four scenarios (AI-Facilitated Direct Democracy → Big Tech Power Grab) on AI, citizen engagement and democratic quality [Tier 1, civic-AI]
...
- [ ] https://dl.acm.org/doi/10.1145/3805689.3812416 — ACM FAccT 2026 (paper): Connective Democratic Tissue — "second-order technologies" for civic ecosystems, drawing on Metagov's interoperability cohorts [Tier 1, civic-AI]
...
- [ ] https://arxiv.org/abs/2606.24635 — arXiv (paper, Lisa Schirch & Beth Goldberg): Visualizing "We the People" — distribution-focused "opinion landscapes" vs binary us-vs-them graphics to reduce polarisation; case study of the Jigsaw × Napolitan Institute deliberation (2,400+ Americans across all 435 congressional districts) [Tier 1, civic-AI]
