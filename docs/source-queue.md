...
- [ ] https://civic.ai/ — Civic AI (framework, Audrey Tang & Caroline Green / Oxford Institute for Ethics in AI): the "6-Pack of Care" (attentiveness, responsibility, competence, responsiveness, solidarity, symbiosis) for bounded local AI agents a community can own, inspect, correct and switch off; grounded in Taiwan's Alignment Assemblies [Tier 1, civic-AI]
...
- [ ] https://convoca.org/ — Convoca (tool/org, team ex-MIT Media Lab): source-traceable RAG sensemaking that turns large volumes of community input (sticky notes to recorded dialogue) into recurring themes tied back to what residents said; Mozilla Democracy × AI cohort; co-designed with NYC planners + North Carolina organizers [Tier 2, civic-AI / toolkit]
