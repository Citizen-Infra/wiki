...
Node **≥22.12** (Netlify pins `NODE_VERSION=22`). Always `npm run build` before deploying — a clean build is the gate; it surfaces broken internal links and missing pages.
